  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        ...
        <h4>1. Eligibility</h4>
        <p>You must be at least 18 years old and capable of entering into legally binding contracts to use our services. By registering or placing an order, you confirm that you meet these criteria.</p>

        <h4>2. Account Registration</h4>
        <p>To rent equipment, you must create an account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.</p>
        ...
        <p>The rental period begins on the delivery or pickup date and ends on the return date. Late returns will incur additional fees calculated on a daily basis.</p>

        <h4>5. Delivery and Returns</h4>
        <p>We offer delivery and pickup options depending on your location based on a fare. You are responsible for returning the equipment in the same condition you received it.</p>

        <h4>6. Damage, Loss, or Theft</h4>
        <p>You are responsible for any damage, loss, or theft of the equipment during the rental period. Repair or replacement costs will be charged to you in case of damage or loss. Optional damage waivers may be available at checkout.</p>

        <h4>7. Cancellations and Refunds</h4>
        <p>Cancellations made at least [e.g., 48 hours] before the rental start date may be eligible for a full refund. No refunds for early returns or late cancellations.</p>

        <h4>8. Payment</h4>
        <p>All payments must be made through our secure online system. We accept [credit cards, PayPal, etc.].</p>

        <h4>9. Limitation of Liability</h4>
        <p>We are not liable for any indirect, incidental, or consequential damages arising from the use of our equipment. Our liability is limited to the total amount paid by you for the rental.</p>

        <h4>10. Intellectual Property</h4>
        <p>All content on our Site, including text, images, and logos, is our property or used with permission. You may not reproduce or use any content without prior written consent.</p>
